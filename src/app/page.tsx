...
export default function Home() {
  return (
    <main>
      <section className="bg-pink-200 h-screen w-640 md:bg-pink-200
       lg:flex  xl:flex">
        {/* left section */}
        <div className=" text-sm py-20 w-2/5 ">
          <h1 className="text-yellow-600 font-extrabold text-6xl 
          tracking-tighter px-20">
            FURNITURE
          </h1>
          ...
          <div className="py-12">
            <div className="ml-24 flex gap-2 ">
              <Image width="20" height="20" src="/github.png" alt="products " />
              <a
                className="text-slate-800 text-xs underline"
                href="https://github.com/MinhalAmin/template"
              >
                https://github.com
              </a>
            </div>
            <div className="ml-24 flex gap-2 py-3 ">
              ...
              <a
                className="text-slate-800 text-xs underline"
                href="https://www.instagram.com/minhal.zariwala_?igsh=c252aGR0Y3VwNjkx"
              >
                www.instagram.com
              </a>
            </div>
            <div className="ml-24 flex gap-2">
            <Image width="19" height="20" src="/gmail.png" alt="products " />
              <a
                className="text-slate-800 text-xs underline"
                href="mailto:minhalmohammedamin@gmail.com"
              >
        ...
        <div className="w-3/5 mr-2 ">
          <div className="bg-white absolute top-0 right-0 h-full w-50 mr-20 shadow-2xl  shadow-slate-400">
            ...
            <div className="flex justify-center py-2 gap-3 content-center">
              ...
              <p className="bg-slate-500 shadow-2xl w-2 h-2 rounded-full "></p>
              <p className="bg-slate-400 shadow-2xl w-2 h-2 rounded-full "></p>
            </div>
            <div className="">
